...
.icon svg { width: 30px; height: 30px; fill: #2563eb; }
h2 { color: #1e293b; margin: 0 0 10px; }
p { color: #64748b; font-size: 14px; line-height: 1.5; margin-bottom: 25px; }
.code { font-family: monospace; font-size: 32px; font-weight: bold; letter-spacing: 4px; color: #2563eb; background: #f8fafc; padding: 15px; border-radius: 8px; border: 1px dashed #cbd5e1; margin-bottom: 25px; }
